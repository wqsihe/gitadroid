...
public class HttpConnection implements Runnable {
	...
	public class SizeMismatchException extends Exception {
		 ...
		 * 
		 */
		private static final long serialVersionUID = 926038880427048336L;
	...
	private void processFileEntity(HttpEntity entity) throws IOException {
		BufferedOutputStream out = new BufferedOutputStream(new FileOutputStream(data),10*1024*1024);
		...
		if (downloadedSize!=totalSize){
			handler.sendMessage(Message.obtain(handler, DID_ERROR, new SizeMismatchException("size mismatch "+downloadedSize+" "+totalSize)));
		}
		else{
